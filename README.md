...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/quiet-thunder-494a#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-thunder-494a
```

A live public deployment of this template is available at [https://quiet-thunder-494a.templates.workers.dev](https://quiet-thunder-494a.templates.workers.dev)
